...
const MainPage: React.FC = () => {
  ...
  const dicionarioOpcao: { [key: number]: string } = {
    1: "Cadastrar Empresa",
    2: "Remover Empresa",
    3: "Atualizar Empresa",
    4: " Cadastrar Produto",
      ...
      <main className="flex p-12 items-center justify-center mt-11">
        {opcao.status ? (
              ...
              <ul className="grid grid-cols-3 gap-4 w-full">
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    ...
                    onClick={() => setOpcao({ status: false, choice: 1 })}
                  >
                    Cadastrar Empresa
                  </a>
                </li>
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 2 })}
                  >
                    Remover Empresa
                  </a>
                </li>
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 3 })}
                  >
                    Atualizar Empresa
                  </a>
                </li>
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 4 })}
                  >
                    Cadastrar Produto
                  </a>
                </li>
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 5 })}
                  >
                ...
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 6 })}
                  >
                    Atualizar Produto
                  </a>
                </li>
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 7 })}
                  >
                    Remover Produto
                  </a>
                </li>
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 8 })}
                  >
                    Registro Financeiro
                  </a>
                </li>
                <li className="p-3 bg-secondary text-white rounded-lg text-center hover:bg-primary transition-colors">
                  <a
                    className="block font-semibold"
                    onClick={() => setOpcao({ status: false, choice: 9 })}
                  >
                    Análise de Dados
                  </a>
                </li>
          ...
          <div className="p-8 bg-white border border-gray-300 rounded-lg shadow-lg text-center flex items-center justify-center">
            <button
              className="text-right text-white font-semibold border border-secondary-300 rounded-full p-4 w-10 h-6 flex justify-center items-center bg-secondary hover:bg-primary"
              onClick={() => setOpcao({ status: true, choice: 0 })}
            >
              &lt;
            </button>
            <strong className="text-2xl font-bold ml-5 text-secondary">
              {dicionarioOpcao[opcao.choice]}{" "}
            </strong>
          </div>
        )}
      </main>
